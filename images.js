...
<body>
    ...
    <nav>
        ...
        <div class="nav-container">
            ...
            <div id="btn-dongvat" class="nav-item" onclick="switchCategory('DONG_VAT')">
                ĐỘNG VẬT <div class="arrow-down"></div>
            </div>

            <div id="btn-bieucam&cuchi" class="nav-item" onclick="switchCategory('BIEU_CAM_&_CU_CHI')">
                BIỂU CẢM & CỬ CHỈ <div class="arrow-down"></div>
            </div>

            <div id="btn-vatlieumienphi" class="nav-item" onclick="switchCategory('VAT_LIEU_MIEN_PHI')">
                VẬT LIỆU MIỄN PHÍ <div class="arrow-down"></div>
            </div>
